...
public class BasicClient {
	...
	public void login(String username, String password) {
		...
		try {
			...
			Packet loginPacket = new Packet(actionType.LOGIN, loginArgs, "tempClient");
	...
	public void sendMessage(String authorId, String chatId, String content) {
		...
		try {
			...
			Packet messagePacket = new Packet(actionType.SEND_MESSAGE, messageArgs, authorId);
	...
	public void logout(String userId) {
		try {
			...
			Packet logoutPacket = new Packet(actionType.LOGOUT, logoutArgs, userId);
