...
public class ITAdmin extends AbstractUser {
	...
	public ITAdmin(String username, String firstName, String lastName, boolean isDisabled, boolean isAdmin) {
		super(username, firstName, lastName, isDisabled, isAdmin);
	}
}
